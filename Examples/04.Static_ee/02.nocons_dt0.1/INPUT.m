...
flag.collision_on_ei=0;
flag.collision_on_ii=0;
ne=8.928e+21;   % 单位cm^-3，n=1时的实际密度。 
Te=1000;    % eV 影响ei碰撞截断，对结果基本无影响，大致给对即可。
Ivc=[3,3];
% conservation
flag.cons_ee_NE=0; %电子-电子碰撞粒子数和能量守恒
flag.cons_ii_NE=0; %同种离子-离子碰撞粒子数和能量守恒
flag.cons_i1i2_NE=0; %不同种离子-离子碰撞粒子数和总能量守恒
flag.cons_ee_P=0;  %电子-电子碰撞动量守恒
flag.cons_E_N=0;  %电场项粒子数守恒
