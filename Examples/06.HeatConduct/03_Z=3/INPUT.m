...
file_start_number=20000;%-1：从分布函数算起；非负：从编号file_start_number的文件算起。
% interruption
...
dist_ini={
    {'heat2',xmax,number_ratio(1),0.99*vTe,1.01*vTe}
    {'heat2',xmax,number_ratio(2),0.99*vTi,1.01*vTi}
    };
density_profile_ini={
    {'const',1}
    {'const',1}
    };
dist_neu_ini={'everywhere',2};
% collisions:
